...
/* API current version */
#define SLURM_API_CURRENT 25

/* API current major */
#define SLURM_API_MAJOR 25

/* API current rev */
#define SLURM_API_REVISION 0

/* Define the API's version */
#define SLURM_API_VERSION 0x190000
